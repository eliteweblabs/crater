{{--
  ...
  linear-gradient(145deg, #f472b6, #c026d3, #6366f1) + #0b0512 label.
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" role="presentation">
                            <tr>
                                ...
                                <td align="center" bgcolor="#c026d3" style="border-radius: 999px; background-color: #c026d3; background-image: linear-gradient(145deg, #f472b6 0%, #c026d3 52%, #6366f1 100%); box-shadow: 0 2px 16px rgba(192, 38, 211, 0.35);">
                                    <a href="{{ $url }}" target="_blank" style="display: inline-block; padding: 12px 24px; border-radius: 999px; color: #0b0512; font-size: 15px; font-weight: 600; letter-spacing: -0.01em; line-height: 1; text-decoration: none;">{{ $slot }}</a>
                                </td>
                                @else
                                <td>
